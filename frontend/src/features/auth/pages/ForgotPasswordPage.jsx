...
export function ForgotPasswordPage() {
  ...
  const form = useForm({
    ...
    defaultValues: { collegeCode: getCollegeCode() || '', email: '' },
  });
  ...
  return (
    ...
    >
      ...
      >
        ...
        {sent ? (
          <p className="text-center text-sm" style={{ color: 'rgba(32,30,29,0.7)' }}>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel style={{ color: 'rgba(32,30,29,0.7)' }}>College code</FormLabel>
                    <FormControl>
                      <Input
                        autoComplete="organization"
                        placeholder="e.g. ARC1234"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel style={{ color: 'rgba(32,30,29,0.7)' }}>Email</FormLabel>
                    <FormControl>
                      <Input
                        type="email"
                        autoComplete="email"
