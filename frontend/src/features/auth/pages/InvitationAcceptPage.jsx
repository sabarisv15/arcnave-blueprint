...
export function InvitationAcceptPage() {
  ...
  async function onSubmit(values) {
    ...
    try {
      ...
      // 401 = invalid/expired invitation, 409 = email already taken.
    ...
    >
      ...
      >
        ...
        <p className="mb-6 text-center text-sm font-medium" style={{ color: 'rgba(32,30,29,0.65)' }}>
          Set your email and password to finish setting up your account.
        </p>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel style={{ color: 'rgba(32,30,29,0.7)' }}>Invitation token</FormLabel>
                  <FormControl>
                    <Input
